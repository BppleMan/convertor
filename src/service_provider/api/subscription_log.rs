...
// impl Serialize for SubscriptionLogs {
//     fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
//     where
//         S: Serializer,
//     {
//         let logs: &[SubscriptionLog] = &self.0;
//         let result = logs.serialize(serializer)?;
//         Ok(result)
//     }
// }

// impl<'de> Deserialize<'de> for SubscriptionLogs {
//     fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
//     where
//         D: serde::Deserializer<'de>,
//     {
//         let logs = Vec::<SubscriptionLog>::deserialize(deserializer)?;
//         Ok(SubscriptionLogs(logs))
//     }
// }
