...
async fn test_subscription(
    ...
    insta::assert_snapshot!(result.raw_url.to_string(), @r#""#);
    insta::assert_snapshot!(result.raw_profile_url.to_string(), @r#""#);
    insta::assert_snapshot!(result.profile_url.to_string(), @r#""#);
    insta::assert_snapshot!(result.sub_logs_url.to_string(), @r#""#);
